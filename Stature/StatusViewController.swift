...
class StatusViewController: UIViewController {
    ...
    func showMessage(_ text: String, messageType: MessageType, autoHide: Bool = true) {
    ...
    func scheduleMessage(_ text: String, inSeconds seconds: TimeInterval, messageType: MessageType) {
        ...
        let timer = Timer.scheduledTimer(withTimeInterval: seconds, repeats: false, block: { [weak self] timer in
            self?.showMessage(text, messageType: messageType)
            timer.invalidate()
        })
    ...
    func showTrackingQualityInfo(for trackingState: ARCamera.TrackingState, autoHide: Bool) {
        showMessage(trackingState.presentationString, messageType: .trackingState, autoHide: autoHide)
    }
    ...
    func escalateFeedback(for trackingState: ARCamera.TrackingState, inSeconds seconds: TimeInterval) {
        ...
        let timer = Timer.scheduledTimer(withTimeInterval: seconds, repeats: false, block: { [unowned self] _ in
            ...
            self.showMessage(message, messageType: .trackingStateEscalation, autoHide: false)
        })
